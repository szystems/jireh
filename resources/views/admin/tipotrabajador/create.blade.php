        ...
        <div class="main-header d-flex align-items-center justify-content-between position-relative">
            <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="page-title">
                    <h5>Nuevo Tipo de Trabajador</h5>
                </div>
            </div>
            <!-- Date range start -->
                ...
                <div class="col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Crear Tipo de Trabajador</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ url('insert-tipo-trabajador') }}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="aplica_comision" name="aplica_comision" value="1" {{ old('aplica_comision') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="requiere_asignacion" name="requiere_asignacion" value="1" {{ old('requiere_asignacion') ? 'checked' : '' }}>
                                    ...
                                    <div id="seccion-comisiones" class="col-12 mt-3" style="display: {{ old('aplica_comision') ? 'block' : 'none' }}">
                                        <div class="card border-secondary">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select class="form-select @error('tipo_comision') is-invalid @enderror" id="tipo_comision" name="tipo_comision">
                                                            ...
                                                            @foreach($tiposComision as $value => $label)
                                                                <option value="{{ $value }}" {{ old('tipo_comision') == $value ? 'selected' : '' }}>
                                                                    {{ $label }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <div class="form-check form-switch mt-4">
                                                            <input class="form-check-input" type="checkbox" id="permite_multiples_trabajadores" name="permite_multiples_trabajadores" value="1" {{ old('permite_multiples_trabajadores') ? 'checked' : '' }}>
                                                ...
                                                <div class="row comision-fijo-porcentaje" id="config-comision" style="display: {{ old('tipo_comision') ? 'flex' : 'none' }};">
                                                    <div class="col-md-6 mb-3" id="valor-comision-container" style="display: {{ in_array(old('tipo_comision'), ['fijo', 'por_servicio', 'personalizado']) ? 'block' : 'none' }};">
                                                        <label for="valor_comision" class="form-label">Monto por Comisión (Q)</label>
                                                        <input type="number" step="0.01" min="0" class="form-control @error('valor_comision') is-invalid @enderror" id="valor_comision" name="valor_comision" value="{{ old('valor_comision') }}">
                                                        @error('valor_comision')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>

                                                    <div class="col-md-6 mb-3" id="porcentaje-comision-container" style="display: {{ in_array(old('tipo_comision'), ['porcentaje_venta', 'porcentaje_ganancia', 'personalizado']) ? 'block' : 'none' }};">
                                                        <label for="porcentaje_comision" class="form-label">Porcentaje de Comisión (%)</label>
                                                        <input type="number" step="0.01" min="0" max="100" class="form-control @error('porcentaje_comision') is-invalid @enderror" id="porcentaje_comision" name="porcentaje_comision" value="{{ old('porcentaje_comision') }}">
