                                    ...
                                    <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                @endif
                                                <form action="{{ url('update-vehiculo/'.$vehiculo->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row gx-3">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="cliente_id" id="fcliente" class="form-select select2" aria-label="Default select example" style="width: 100%;">
                                                                    <option value="" {{ old('cliente_id', $vehiculo->cliente_id) == '' ? ' selected' : '' }}>Todos</option>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="marca" type="text" class="form-control" placeholder="Marca del vehiculo..." value="{{ $vehiculo->marca }}" />
                                                                @if ($errors->has('marca'))
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="modelo" type="text" class="form-control" placeholder="Modelo del vehiculo..." value="{{ $vehiculo->modelo }}" />
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="ano" class="form-control">
                                                                    ...
                                                                    @for ($year = date('Y'); $year >= 1900; $year--)
                                                                        <option value="{{ $year }}" {{ $vehiculo->ano == $year ? 'selected' : '' }}>{{ $year }}</option>
                                                                    @endfor
                                                                </select>
                                                                @if ($errors->has('ano'))
                                                                    <span class="help-block opacity-7">
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="color" type="text" class="form-control" placeholder="Color del vehiculo..." value="{{ $vehiculo->color }}" />
                                                                @if ($errors->has('color'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="placa" type="text" class="form-control" placeholder="Placa del vehiculo..." value="{{ $vehiculo->placa }}" />
                                                                @if ($errors->has('placa'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="vin" type="text" class="form-control" placeholder="VIN del vehiculo..." value="{{ $vehiculo->vin }}" />
                                                                @if ($errors->has('vin'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
