                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="vin" id="vin" type="text" class="form-control" placeholder="Número VIN o chasis (opcional)..." value="{{ old('vin', $vehiculo->vin) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Número de Identificación del Vehículo - Normalmente 17 caracteres (Opcional)" />
                                                        </div>
                                                        @if ($errors->has('vin'))
