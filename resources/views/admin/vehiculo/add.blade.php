                ...
                <div class="col-sm-12 col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-light">
                            <h5 class="card-title"><i class="bi bi-plus-circle-fill text-success"></i> Registrar Nuevo Vehículo</h5>
                        </div>
                        <div class="card-body">
                            @if (count($errors)>0)
                            ...
                            <form action="{{ url('insert-vehiculo') }}" method="POST" enctype="multipart/form-data" id="vehiculoForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-8">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="marca" id="marca" type="text" class="form-control" placeholder="Ej: Toyota, Honda, Ford..." value="{{ old('marca') }}" required />
                                                        </div>
                                                        @if ($errors->has('marca'))
                                                            <div class="text-danger mt-1">{{ $errors->first('marca') }}</div>
                                                        @endif
                                                        <div class="form-text">Ingrese la marca del fabricante del vehículo</div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="modelo" id="modelo" type="text" class="form-control" placeholder="Ej: Corolla, Civic, Ranger..." value="{{ old('modelo') }}" required />
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="color" id="color" type="text" class="form-control" placeholder="Ej: Rojo, Negro, Plata..." value="{{ old('color') }}" required />
                                                        </div>
                                                        @if ($errors->has('color'))
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select name="tipo_vehiculo" id="tipo_vehiculo" class="form-select">
                                                            ...
                                                            <option value="Sedan" {{ old('tipo_vehiculo') == 'Sedan' ? 'selected' : '' }}>Sedán</option>
                                                            <option value="SUV" {{ old('tipo_vehiculo') == 'SUV' ? 'selected' : '' }}>SUV</option>
                                                            <option value="Pickup" {{ old('tipo_vehiculo') == 'Pickup' ? 'selected' : '' }}>Pickup</option>
                                                            <option value="Hatchback" {{ old('tipo_vehiculo') == 'Hatchback' ? 'selected' : '' }}>Hatchback</option>
                                                            <option value="Minivan" {{ old('tipo_vehiculo') == 'Minivan' ? 'selected' : '' }}>Minivan</option>
                                                            <option value="Deportivo" {{ old('tipo_vehiculo') == 'Deportivo' ? 'selected' : '' }}>Deportivo</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="placa" id="placa" type="text" class="form-control" placeholder="Número de placa..." value="{{ old('placa') }}" required />
                                                        </div>
                                                        @if ($errors->has('placa'))
                                            ...
                                            <div class="card-body">
                                                <div class="row g-3">
                                                    <div class="col-md-12">
                                                        ...
                                                        <select name="cliente_id" id="fcliente" class="form-select select2" required>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="text-center mb-3">
                                                    <img id="preview-image" src="{{ asset('assets/imgs/vehiculos/vehiculoicon.png') }}"
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4">
                                    <a href="{{ url('vehiculos') }}" class="btn btn-outline-danger">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#clear-image').click(function(){
                $('#fotografia').val('');
                $('#preview-image').attr('src', '{{ asset('assets/imgs/vehiculos/vehiculoicon.png') }}');
            });
            ...
            $('#refreshClientesBtn').click(function() {
                ...
                $.ajax({
                    url: '{{ url("get-clientes") }}', // Necesitarás crear esta ruta
                    method: 'GET',
                    dataType: 'json',
