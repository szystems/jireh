                                                    ...
                                                    <div class="row gx-3">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="nombre" type="text" class="form-control" placeholder="Nombre de la unidad de medida..." value="{{ $unidad->nombre }}" />
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="abreviatura" type="text" class="form-control" placeholder="Abreviatura de la unidad de medida..." value="{{ $unidad->abreviatura }}" />
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="tipo" class="form-select" aria-label="Default select example">
                                                                    ...
                                                                    <option value="unidad"{{ $unidad->tipo == 'unidad' ? ' selected' : '' }}>unidad</option>
                                                                    <option value="decimal"{{ $unidad->tipo == 'decimal' ? ' selected' : '' }}>decimal</option>
                                                                </select>
                                                                @if ($errors->has('tipo'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
