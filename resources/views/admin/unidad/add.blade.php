                ...
                <div class="col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Nueva Unidad de Medida</div>
                        </div>
                        <div class="card-body">
                            @if (session('status'))
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input id="nombre" name="nombre" type="text" class="form-control"
                                                placeholder="Nombre de la unidad de medida" value="{{ old('nombre') }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input id="abreviatura" name="abreviatura" type="text" class="form-control"
                                                placeholder="Abreviatura" value="{{ old('abreviatura') }}" required />
                                        </div>
                                    </div>
