                    ...
                    <div class="card">
                        <div class="card-header bg-success bg-gradient">
                            <h5 class="card-title text-white mb-3">
                                <i class="bi bi-plus-circle-fill me-2"></i>Crear Nuevo Proveedor
                            </h5>
                        </div>
                        <div class="card-body">
                            @if (count($errors)>0)
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 mb-3">
                                                        ...
                                                        <input name="nombre" type="text" class="form-control" placeholder="Nombre del proveedor..." value="{{ old('nombre') }}" />
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="contacto" type="text" class="form-control" placeholder="Nombre del contacto..." value="{{ old('contacto') }}" />
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="email" type="email" class="form-control" placeholder="Email del proveedor..." value="{{ old('email') }}" />
                                                        @if ($errors->has('email'))
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="telefono" type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" class="form-control" placeholder="Teléfono del proveedor..." value="{{ old('telefono') }}" />
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="banco" type="text" class="form-control" placeholder="Nombre del banco..." value="{{ old('banco') }}" />
                                                        @if ($errors->has('banco'))
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="nombre_cuenta" type="text" class="form-control" placeholder="Nombre de la cuenta..." value="{{ old('nombre_cuenta') }}" />
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select name="tipo_cuenta" class="form-select">
                                                            ...
                                                            <option value="Monetaria" {{ old('tipo_cuenta') == 'Monetaria' ? 'selected' : '' }}>Monetaria</option>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input name="numero_cuenta" type="text" class="form-control" placeholder="Número de la cuenta..." value="{{ old('numero_cuenta') }}" />
