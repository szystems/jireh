    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('comisiones/por-vendedor') }}" method="GET" class="row">
                                ...
                                <div class="col-md-3 mb-3 d-flex align-items-end">
                                    ...
                                    <a href="{{ url('comisiones/por-vendedor') }}" class="btn btn-secondary ms-2">Limpiar</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card h-100">
                            <div class="card-header bg-primary text-white">
                                <h5>{{ $vendedor->name }}</h5>
                                <div class="small">{{ $vendedor->email }}</div>
                            </div>
                            <div class="card-body">
                                <div class="row mb-4">
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <i class="bi bi-graph-up display-6 text-primary me-3"></i>
                                            </div>
                                            <div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <div class="fw-bold">{{ $vendedor->ventas->count() }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <!-- Estado actual de comisiones -->
                                <div class="mb-4">
                                    <h6>Estado de Comisiones</h6>
                                ...
                                <!-- Metas de venta activas -->
                                <div class="mb-4">
                                    <h6>Metas de Venta Activas</h6>
                                    @php
                                        $metasActivas = $vendedor->metasActuales()->get();
                                    @endphp

                                    @if ($metasActivas->count() > 0)
                                        <div class="table-responsive">
                                            <table class="table table-sm">
                                                <thead>
                                                    <tr>
                                    ...
                                    @else
                                        <div class="alert alert-info">No hay metas de ventas activas.</div>
                                    @endif
                                </div>
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                <a href="{{ url('show-user/'.$vendedor->id) }}" class="btn btn-outline-secondary">
                                    <i class="bi bi-person"></i> Ver Perfil
                                </a>
                                <a href="{{ url('comisiones?tipo_receptor=usuario&commissionable_id='.$vendedor->id) }}" class="btn btn-outline-primary">
                                    <i class="bi bi-list-check"></i> Ver Comisiones
                                </a>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="col-12">
                        <div class="alert alert-info">
                            No hay vendedores con comisiones que coincidan con los filtros seleccionados.
                        </div>
                    </div>
                @endforelse
            </div>
            ...
            <div class="d-flex justify-content-center mt-4">
                {{ $vendedores->appends(request()->query())->links() }}
            </div>
        </div>
    </div>
</div>
